    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        button.setOnClickListener{
            ...
            if(login == "" || pass == ""){
                ...
                if(isAuth){
                    Toast.makeText(this, "Person with login - ${login} log in", Toast.LENGTH_SHORT).show()
                    ...
                    Toast.makeText(this, "Person with login - ${login} not log in", Toast.LENGTH_SHORT).show()
                }
            }
        }
